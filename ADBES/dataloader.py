...
def get_features_and_labels(examples, label_list, tokenizer, max_seq_length):
    """
    Convert a set of examples into model-ready features and labels.
    
    Args:
        examples: A list of examples, where each example is a simple object with attributes
                  text_a (the text to tokenize) and label (the label of the text).
        label_list: A list of all possible labels.
        tokenizer: An instance of a BERT tokenizer.
        max_seq_length: The maximum total input sequence length after tokenization.
        
    Returns:
        A tuple of two elements:
        - features: A list of InputFeatures, which include input IDs, attention masks,
                    segment IDs, and label IDs.
        - labels: A list of numeric label IDs corresponding to the input features.
    """
    features = convert_examples_to_features(examples, label_list, max_seq_length, tokenizer)
    labels = [feature.label_id for feature in features]
