...
def init_model():
    ...
    parser.add_argument("--bert_model", default="/content/home/drive/MyDrive/Adaptive-Decision-Boundary/uncased_L-12_H-768_A-12", type=str, help="The path for the pre-trained bert model.")
    ...
    parser.add_argument("--num_train_epochs", default=70, type=float,
                        help="Total number of training epochs to perform.") 
    parser.add_argument("--train_batch_size", default=128, type=int,
                        help="Batch size for training.")
    parser.add_argument("--eval_batch_size", default=64, type=int,
                        help="Batch size for evaluation.")    
    parser.add_argument("--wait_patient", default=7, type=int,
